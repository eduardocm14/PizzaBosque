...
type
  TfrmConsultaVendas = class(TForm)
    ...
    N1: TMenuItem;
    opConsultaVendaspCaixas: TMenuItem;
    ...
    procedure opConsultaVendaspCaixasClick(Sender: TObject);
    procedure FecharCaixa1Click(Sender: TObject);
    procedure FormShow(Sender: TObject);
    procedure dbgConsultaCaixasDblClick(Sender: TObject);
  private
...
procedure TfrmConsultaVendas.opConsultaVendaspCaixasClick(Sender: TObject);
begin
  if fNivelUsuario(iGbCodUsuario) = 0 then
  begin
    sGbCxAbertFechado := dmConsultaFechaCaixas.fdqConsultaFechaCaixasstatus.AsString;
...
procedure TfrmConsultaVendas.dbgConsultaCaixasDblClick(Sender: TObject);
begin
  opConsultaVendaspCaixas.Click;
end;
...
begin
  ...
  begin
    ...
    begin
      if application.MessageBox(Pchar(Format(msg24,[FieldByName('ID').AsString])), cMsg, MB_YESNO + MB_ICONINFORMATION) = IDYES then
      begin
